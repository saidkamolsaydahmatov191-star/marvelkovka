        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            <div className="space-y-6 text-white/60 leading-relaxed font-light">
              <p>
                "Marvel Kovka" – 2019-yildan buyon nafaqat ishlab chiqarish, balki har bir buyurtmaga jon bagʻishlaydigan ijodiy ustaxonadir. Biz faqatgina temir buyumlarini yasashga ixtisoslas, balki hunarmand bo'lishga intilaman.
              </p>
              <p>
                Biz har bir detalga alohida eʼtibor qaratamiz. Bizning darvozalarimiz uyingizning tashrif qogʻozi boʻlib xizmat qilsa, panjaralarimiz va boshqa temir buyumlarimiz xavfsizlik bilan qamalovga tayyordir.
              </p>
